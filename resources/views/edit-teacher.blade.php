                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" enctype="multipart/form-data" action="{{ route('teacher.update') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('images') }}/{{ $teacher->profileimage }}" id="previewImg" alt="profile image" style="max-width: 130px; margin-top:20px;">
                                </div>
